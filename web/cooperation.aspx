<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cooperation.aspx.cs" Inherits="web.cooperation" %>
...
<li><a href="cooperation.aspx?id=<%#Eval("Id") %>" <%#Eval("Id").Equals(Id)?"class=\"current\"":"" %>><%#Eval("NewTitle") %></a></li>
...
<div style="padding:10px;line-height:20px;padding-left:20px;">工作时间：09：00-19：00<BR />
  ...
  <tr>
    ...
    <td width="10">&nbsp;</td>
    <td valign="top">
        <div style="line-height:36px;padding:10px 20px 20px 20px;font-size:14px;color:#666;border:1px solid #ededed;margin-bottom:10px;">
        <%=NewContent%>
        </div>
    </td>
  </tr>
