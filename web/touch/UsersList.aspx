<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersList.aspx.cs" Inherits="web.touch.UsersList" %>
            ...
            <tr>
                ...
                <td class="mm">
                    <div style="padding:5px 0;">
                        ...
                        手机号：<input type="text" id="txtmobile" runat="server" class="inpu" />
	                ...
	                <asp:DataGrid ID="myGrid" runat="server" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" CssClass="grid" border="0" align="center" BorderColor="#C6DAE5"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="会员等级">
                                <ItemStyle HorizontalAlign="center"/>
				                <HeaderStyle Width="3%"/>     
                                <ItemTemplate>
                                    <%#GetGroupName(Eval("UserGroup"))%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:TemplateColumn HeaderText="管理信息">
                                ...
                                <ItemStyle HorizontalAlign="center"  />
                                <ItemTemplate>
                                    <a href="UsersEdit.aspx?id=<%#Eval("Id") %>"><img src="images/icon_edit.gif" border="0" alt="编辑" align="absmiddle" />编辑</a>&nbsp;&nbsp;
