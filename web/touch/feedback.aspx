<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="web.touch.feedback" %>
...
<body>
    ...
    <div class="mframe">
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
            <tr>
                <td class="tl"></td>
                <td class="tm"><span class="tt">意见反馈管理</span></td>
                <td class="tr"></td>
            </tr>
        </table>
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
                ...
                <td class="mm">
                    ...
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CssClass="grid" border="0" align="center" BorderColor="#C6DAE5"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="主 题">
                                <HeaderStyle Width="5%" />
                                <ItemStyle HorizontalAlign="center"/>
                                <ItemTemplate>
                                    <%#Eval("Subject")%>
                            ...
                            <asp:TemplateColumn>
                                <HeaderStyle Width="8%" />
                                <HeaderTemplate>内 容</HeaderTemplate> 
                                <ItemStyle HorizontalAlign="center"/> 
                                <ItemTemplate>
                                    <%#Eval("Content")%>
                                </ItemTemplate>    
