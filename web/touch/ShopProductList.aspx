<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopProductList.aspx.cs" Inherits="web.touch.ShopProductList" %>
...
<body>
    ...
    <div class="mframe">
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
            <tr>
                <td class="tl"></td>
                <td class="tm"><span class="tt"><%=ShopName %>的菜品管理</span></td>
                <td class="tr"></td>
            </tr>
        </table>
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td class="mm">
                    <div style="padding:5px 0px 5px 0px;">
                        <a href="ShopProductAdd.aspx?shopid=<%=shopid %>&keepThis=true&TB_iframe=true" class="fLink thickbox">添 加</a>
	                ...
	                <asp:DataGrid ID="myGrid" runat="server" ShowHeader="true" ShowFooter="false" AutoGenerateColumns="False" CssClass="grid" border="0" align="center" BorderColor="#C6DAE5"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="菜品名称">
                                <ItemStyle HorizontalAlign="center"/>
				                <HeaderStyle Width="5%"/> 
                                <ItemTemplate>
                                    <%#Eval("ProductName")%>
                                    <asp:HiddenField ID="hf_simg" runat="server" Value='<%#Eval("ImgSrc") %>' />
                                </ItemTemplate>    
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="菜品类别">
                                <ItemStyle HorizontalAlign="center"/>
				                <HeaderStyle Width="3%"/> 
                                <ItemTemplate>
                                    <%#GetTypeNameById(Eval("typeid"))%>
                                </ItemTemplate>    
                            </asp:TemplateColumn>
                            <asp:TemplateColumn HeaderText="价 格">
                                <ItemStyle HorizontalAlign="center"/>
				                <HeaderStyle Width="2%"/> 
                                <ItemTemplate>
                                    <%#Eval("Price")%>
                            ...
                            <asp:TemplateColumn HeaderText="管理信息">
                                ...
                                <ItemStyle HorizontalAlign="center"  />
                                <ItemTemplate>
                                    <a href="ShopProductEdit.aspx?id=<%#Eval("Id") %>&keepThis=true&TB_iframe=true" class="thickbox"><img src="images/icon_edit.gif" border="0" alt="编辑" align="absmiddle" />编辑</a>&nbsp;&nbsp;
