<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="busecooperation.aspx.cs" Inherits="web.busecooperation" %>
...
<div id="dh00">
<ul>
<li><a href="busecooperation.aspx" class="current">商家合作</a></li>
  ...
  <tr>
    ...
    <td valign="top">
        <div style="line-height:36px;padding:10px 20px 20px 20px;font-size:13px;color:#666;border:1px solid #ededed;margin-bottom:10px;">
            ...
            <tr>
                <td style="width:80px;">商家名称：</td>
                <td><input id="txtshopname" runat="server" class="inpu" />
                    <asp:RequiredFieldValidator ID="rfvshopname" runat="server" ControlToValidate="txtshopname" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>联系人：</td>
            ...
            <tr>
                <td>联系号码：</td>
                <td><input id="txtphone" runat="server" class="inpu" />
                    <asp:RequiredFieldValidator ID="rfvphone" runat="server" ControlToValidate="txtphone" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>商家地址：</td>
                <td><input id="txtaddress" runat="server" class="inpu" style="width:350px;" />
                    <asp:RequiredFieldValidator ID="rfvaddress" runat="server" ControlToValidate="txtaddress" ErrorMessage="*"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td></td>
