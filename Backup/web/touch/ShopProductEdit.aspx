<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopProductEdit.aspx.cs" Inherits="web.touch.ShopProductEdit" %>
        ...
        <td class="mm">   
            ...
            <tr>
                ...
                <td><input type="text" id="txtImgSrc" runat="server" class="inpu" style="width:230px;" />
                    ...
                    <asp:Image ID="ProImgSrc" runat="server" />
                </td>
            </tr>
            <tr>
