<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductTypeList.aspx.cs" Inherits="web.touch.ProductTypeList" %>
...
<body>
    ...
    <div class="mframe">
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
            <tr>
                <td class="tl"></td>
                <td class="tm"><span class="tt"><%=ShopName %>的菜品分类</span></td>
                <td class="tr"></td>
            </tr>
        </table>
        <table width="98%" align="center" cellspacing="0" cellpadding="0">
