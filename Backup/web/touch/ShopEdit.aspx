<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShopEdit.aspx.cs" Inherits="web.admin.ShopEdit" %>
    ...
    <tr>
        ...
        <td class="mm">   
            ...
            <tr>
                ...
                <td>
                    上午：<input type="text" id="txtamtime" runat="server" class="inpu" />
                    下午：<input type="text" id="txtpmtime" runat="server" class="inpu" />
            ...
            <tr>
                ...
                <td><input type="text" id="txtLimit" runat="server" class="inpu" value="0.0" style="width:50px;" onblur="VialdPrice(this)" /><span class="explain">例如：20.0</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br /><asp:Image ID="ShopPic" runat="server" />
                </td>
            </tr>
            <tr>
