<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsEdit.aspx.cs" Inherits="web.touch.NewsEdit" ValidateRequest="false" %>
                ...
                <td valign="top">
                    <script type="text/javascript">
                        function showFCK() {
                            ...
                            document.getElementById("ReHeightFCK").style.display = 'block';
                        }
                    </script>
                    <textarea name="txtArticleContent" id="txtArticleContent" rows="12" cols="80" class="area" runat="server"></textarea><br/>
                    <span id="ReHeightFCK" style="display:none"><a href="javascript:resizeEditor('txtArticleContent',100)"><img src="images/btn/bt_open.gif" border='0'></a> <a href="javascript:resizeEditor('txtArticleContent',-100)"><img src="images/btn/bt_close.gif" border='0'></a></span>
