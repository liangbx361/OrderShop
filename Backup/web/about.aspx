...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="80%" height="20" id="path2">当前位置：<a href="/">邀您吃饭</a> > 公司信息</td>
    <td width="4%">分享：</td>
...
<div id="dh00">
<ul>
<li><a href="feedback.aspx">意见反馈</a>
<asp:Repeater ID="rpt_list" runat="server" EnableViewState="false"><ItemTemplate>
<li><a href="about.aspx?id=<%#Eval("Id") %>" <%#Eval("Id").Equals(Id)?"class=\"current\"":"" %>><%#Eval("NewTitle") %></a></li>
