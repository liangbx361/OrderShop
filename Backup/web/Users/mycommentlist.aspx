...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="af">
  ...
  <tr>
    <td height="25" colspan="2"><span class="bdms_15" style="float:left;"><div class="star<%#Eval("TotalPoint") %>"></div></span> <span class="bdms_07">口味：<span><%#Eval("TastePoint")%></span> 环境：<span><%#Eval("MilieuPoint")%></span> 服务：<span><%#Eval("ServicePoint")%></span></td>
    </tr>
  <tr>
    <td colspan="2" style="padding:10px 0;line-height:20px"><%#Eval("CommentContent")%></td>
    </tr>
  <tr>
    <td width="95%" height="25" bgcolor="#f9f9f9" style="color:#acb5b4">于<%#Eval("AddTime")%>&nbsp;发布评论</td>
