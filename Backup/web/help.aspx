<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="help.aspx.cs" Inherits="web.help" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="80%" height="20" id="path2">当前位置：<a href="/">邀您吃饭</a> > 帮助中心</td>
    <td width="4%">分享：</td>
...
<li id="dh01"><a href="help.aspx?id=<%#Eval("Id") %>" <%#Eval("Id").Equals(Id)?"class=\"current\"":"" %>><%#Eval("NewTitle") %></a></li>
...
<div style="padding:10px;line-height:20px;padding-left:20px;">工作时间：09：00-19：00<BR />
  ...
  <tr>
    ...
    <td width="10">&nbsp;</td>
    <td valign="top"><div style="line-height:36px;padding:10px 20px 20px 20px;font-size:14px;color:#666;border:1px solid #ededed;margin-bottom:10px;">
        <%=NewContent %>
</div></td>
  </tr>
</table>
